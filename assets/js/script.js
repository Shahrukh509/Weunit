     ...
     // script for application component

     var social_name = "";

$(document).on('click','.social_click', function(){

  social_name = $(this).attr('id');
  // alert('hi')
  // $('#put_social_name').remove();
  $('#put_social_name').html(social_name);
...
$(document).on('click','.storing_social_links', function(){
    ...
    success: function(response){
     ...
     if(response.success == true){
        ...
        Swal.fire({
             icon: 'success',
              title: 'Successfull',
              text: 'Your social link has been added!',
              timer: 3000
       });
     ...
     location.href="application";
         ...
         $('.url_error').text('');
        $('.url_error').text('URL should not be empty');
    }
...
$(document).ready(function(){
    ...
    function updatePostOrder(){
          ...
          $('.social_data').each(function(index, element) {
            ...
            success: function(response) {
                if (response.status == true) {
                    ...
                    Swal.fire({
                                 icon: 'success',
                                  title: 'Successfull',
                                  text: 'Your cronology has been updated!',
                                  timer: 3000
                    });
