...
<div class="row">
        <div class="col-xs-12 col-sm-9 offset-sm-1 col-md-9 col-lg-12 col-xl-10 col-xxl-12 mx-auto" style="padding: 0;">
                ...
                <div class="temp1 temp6 temp61" style="background: url(public/assets/images/user/{{ ($design->background_image)? $design->background_image: 'Ebene1.png' }}) !important;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-4 ">
                            <div class="bbb1">
                                <img src="http://localhost/weunit/public/assets/images/user/{{ $design->logo }}"  class="w-50 pull-right">
                            </div>
                        </div>
                    </div>
