...
<div class="row">
<div style="padding: 0;background-color:{{ ($design->background_color)? $design->background_color:'#373532;'}}" class="col-xs-12 col-sm-9 offset-sm-1 col-md-9 col-lg-12 col-xl-10 col-xxl-12 mx-auto temp2-bg" >
     ...
     <a href="#" class="text-decoration-none text-white">
        ...
        <div class="text-center temp2 temp4 temp41 temp410"style="background: url(public/assets/images/user/{{ ($design->background_image)? $design->background_image: 'ac1.PNG' }}) !important;">
            <a class="ac-1" href="#">
