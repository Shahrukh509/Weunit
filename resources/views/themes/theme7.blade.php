...
<div class="row">
<div class="col-xs-12 col-sm-9 offset-sm-1 col-md-9 col-lg-12 col-xl-10 col-xxl-12 mx-auto temp2-bg" style="padding: 0;background-color:{{ ($design->background_color)? $design->background_color:'#D0BCA3;'}} " >
<a href="#" class="text-decoration-none text-white">
<!-- <div class="text-center">
<img src="images/t2.png" class="img-fluid">
</div> -->
<div class="text-center temp2_new" style="background: url(public/assets/images/user/{{ ($design->background_image)? $design->background_image: 'Ebene1.png' }}) !important; height: 60%; border-radius: 70px">
