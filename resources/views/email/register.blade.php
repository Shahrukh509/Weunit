...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            <h4 class="heading">We are pleased to confirm that your registration. </h4>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <h4 > To Verify Your email <a href="{{url('http://localhost/practicenew/public/')}}">Link</a><b>
