<div class="col-lg-5 col-xxl-4" id="designTabFix1" style="padding:0;">
    ...
    @if($designComponent == true)
        <div class="left-side-h remove-margin" style="height:550px;margin-top: 220px; border-left: 1px solid grey;">
    @else
        <div class="left-side-h remove-margin" style="height:550px;margin-top: 100px; border-left: 1px solid grey;">
    @endif
    {{-- <div class="left-side-h remove-margin" style="height:550px;margin-top: @if (Route::CurrentRouteName() == 'design') {{ '220px;' }} @else {{ '100px;' }} @endif border-left: 1px solid grey;"> --}}
       ...
       <div class="mt-3">
          ...
          {{-- Theme Preview --}}
            ...
            @php
                $personals = App\Models\Personal::where('user_id', Auth::user()->id)->first();
            ...
            @if($theme == 1)
            @php $themeOne =  App\Models\Design::where('user_id', Auth::user()->id)->where('theme', 1)->first(); @endphp
            <div class="col-md-12">
                <div class="row">
                <div style="padding: 0; background-color: {{ (isset($themeOne->background_color)) ? $themeOne->background_color : '#000' }} ;" class="col-xs-12 col-sm-9 offset-sm-1 col-md-9 col-lg-12 col-xl-12 col-xxl-12 mx-auto temp2-bg">
                    ...
                    <div class="row i2 g-3 justify-content-center">
                        ...
                        <div class="col-10">
                            <div class="owl-carousel owl-theme bbb_viewed_slider_preview" wire:ignore>
                                <div class="owl-item">
            ...
            @elseif($theme == 2)
            @php $themeTwo =  App\Models\Design::where('user_id', Auth::user()->id)->where('theme', 2)->first(); @endphp
            <div class="col-md-12">
                <div class="row">
            ...
            @elseif($theme == 3)
            @php $themeThree = App\Models\Design::where('user_id', Auth::user()->id)->where('theme', 3)->first(); @endphp
            ...
            @php $themeFour = App\Models\Design::where('user_id', Auth::user()->id)->where('theme', 4)->first(); @endphp
            ...
            @php $themeFive = App\Models\Design::where('user_id', Auth::user()->id)->where('theme', 5)->first(); @endphp
            <div class="col-md-12" >
                <div class="row">
                    <div class="col-xs-12 col-sm-9 offset-sm-1 col-md-9 col-lg-12 col-xl-12 col-xxl-12 mx-auto" style="padding: 0;">
                        <a href="#" class="text-decoration-none text-white">
            ...
            @php $themeSix = App\Models\Design::where('user_id', Auth::user()->id)->where('theme', 6)->first(); @endphp
            <div class="col-md-12">
                <div class="row">
                            ...
                            {{-- <div class="temp1"> --}}
                                ...
                                <div class="row i2 g-3 justify-content-center">
                                    <!-- <div class="bbb_main_container"> -->
                                        ...
                                        <div class="col-10">
                                            <div class="owl-carousel owl-theme bbb_viewed_slider_preview_6" wire:ignore>
                                                <div class="owl-item">
                                                    <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                        <div class="row">
                                                            <div class="col-2 mx-auto">
            ...
            @php $themeSeven= App\Models\Design::where('user_id', Auth::user()->id)->where('theme', 7)->first(); @endphp
            <div class="col-md-12">
                <div class="row">
            ...
            @php $themeEight= App\Models\Design::where('user_id', Auth::user()->id)->where('theme', 8)->first(); @endphp
            <div class="col-md-12">
                <div class="row">
            ...
            @php $themeNine= App\Models\Design::where('user_id', Auth::user()->id)->where('theme', 9)->first(); @endphp
            <div class="col-md-12">
                <div class="row">
                    <div class="col-xs-12 col-sm-9 offset-sm-1 col-md-9 col-lg-12 col-xl-12 col-xxl-12 mx-auto p-0">
                        <a href="#" class="text-decoration-none text-white">
            ...
            @elseif($theme == 10)
            @php $themeTen= App\Models\Design::where('user_id', Auth::user()->id)->where('theme', 10)->first(); @endphp
            <div class="col-md-12">
                <div class="row">
                    <div class="col-xs-12 col-sm-9 offset-sm-1 col-md-9 col-lg-12 col-xl-12 col-xxl-12 mx-auto p-0">
                        <a href="#" class="text-decoration-none text-white">
            ...
            @php $themeEleven = App\Models\Design::where('user_id', Auth::user()->id)->where('theme', 11)->first(); @endphp
            <div class="col-md-12">
                <div class="row">
                    <div class="col-xs-12 col-sm-9 offset-sm-1 col-md-9 col-lg-12 col-xl-12 col-xxl-12 mx-auto" style="padding: 0;">
                        <a href="#" class="text-decoration-none text-white">
