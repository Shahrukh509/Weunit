...
$(document).ready(function () {
    if ($(".bbb_viewed_slider_theme").length) {
        var viewedSlider = $(".bbb_viewed_slider_theme");
        ...
        if ($(".bbb_viewed_prev_theme").length) {
            var prev = $(".bbb_viewed_prev_theme");
            prev.on("click", function () {
                viewedSlider.trigger("prev.owl.carousel");
            });
        }

        if ($(".bbb_viewed_next_theme").length) {
            var next = $(".bbb_viewed_next_theme");
            next.on("click", function () {
                viewedSlider.trigger("next.owl.carousel");
            });
        }
